"""
Django settings for CaffeReviewer project.
...
TEMPLATES = [
    {
        ...
        'DIRS': ['templates', 'CaffeRatings/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'CaffeReviewer.wsgi.application'
...
AUTH_USER_MODEL = "CaffeRatings.MineUser"
...
STATICFILES_DIRS = [
    BASE_DIR / "static",
    'CaffeRatings/static',  # This is for global static files
]
